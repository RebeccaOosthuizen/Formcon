...
export default function ProductUpload() {
  ...
  <div className="mb-4">
        <button onClick={handleAddSize} className="bg-blue-500 text-white px-2 py-1 rounded">Add Size</button>
        <button onClick={handleAddMaterial} className="bg-blue-500 text-white px-2 py-1 ml-2 rounded">Add Material</button>
      </div>
              ...
              {materials.map(material => (
                <td key={`${size}_${material}`} className="border border-gray-300 px-4 py-2">
                  <input
                    ...
                    onChange={(e) => handlePriceChange(size, material, e.target.value)}
      ...
      <div className="my-4">
        <input type="file" multiple onChange={handleFileInput} className="mb-2" />
      </div>
